...
const NavCircle = ({ label, Logo, url }) => {
  ...
  const selectedCircleStyle =
    'w-14 h-14 text-orange-800 dark:text-white flex justify-center items-center radial-gradient-bg-hover rounded-full border-2 border-solid border-orange-900/40 dark:border-white/60 group relative';
  return (
